...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(dynamic error) {
    if (error is DioError) {
      //error from response of api or from dio
  ...
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.SEND_TIMEOUT:
        return Failure(ResponseCode.SEND_TIMOUT, ResponseMessage.SEND_TIMOUT);
      ...
      case DataSource.DEFAULT:
        return Failure(ResponseCode.UNKNOWN, ResponseMessage.DEFAULT);
    }
  }
}
...
class ResponseCode {
  ...
  static const int NOT_CONTENT = 201;
...
class ResponseMessage {
  ...
  static const String NOT_CONTENT = "success";
