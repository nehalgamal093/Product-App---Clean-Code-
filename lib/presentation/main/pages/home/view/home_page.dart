...
import 'package:new_project_flutter_udemy/presentation/main/pages/home/viewmodel/home_viewmodel.dart';
  ...
  Widget _getSection(String title) {
    return Padding(
      padding: const EdgeInsets.only(
          top: AppPadding.p12, left: AppPadding.p12, bottom: AppPadding.p2),
      child: Text(
        title,
